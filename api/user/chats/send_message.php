...
if (getenv('REQUEST_METHOD') == $apimethod) {
    try{    
        ...
        $reciever = isset($_POST['reciever_id']) ? $utility_class_call->clean_user_data($_POST['reciever_id']) : '';
        $message = isset($_POST['message']) ? $utility_class_call->clean_user_data($_POST['message']) : '';
